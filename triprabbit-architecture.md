...
TripRabbit is a simple, local-first Android application for recording and reviewing vehicle odometer readings.
...
```text
com.jacobgain.triprabbit
│
├── TripRabbitApplication.kt
├── MainActivity.kt
│
├── core
│   ├── database
│   │   ├── TripRabbitDatabase.kt
│   │   ├── dao
│   │   ├── entity
│   │   └── converter
│   │
...
Customization is an important feature of TripRabbit.
...
Support restoring TripRabbit JSON exports.
...
Implement a functional Android application called **TripRabbit** based on this specification.
