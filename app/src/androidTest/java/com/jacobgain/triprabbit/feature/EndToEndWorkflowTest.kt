package com.jacobgain.triprabbit.feature
...
class EndToEndWorkflowTest {
    ...
    @Before fun launchFreshApp(){
        ...
        context.deleteDatabase("triprabbit.db")
        context.filesDir.resolve("datastore/app.preferences_pb").delete()
        context.startActivity(Intent(context,Class.forName("com.jacobgain.triprabbit.MainActivity")).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK))
        waitFor("Get Started")
    }
    ...
    @Test fun createVehicleAddReadingAndEditHistory(){
        ...
        waitFor("TripRabbit");waitForContains("Golf");waitFor("120,000")
        ...
        device.pressBack();waitFor("TripRabbit");click("Vehicles");clickDescription("Add Vehicle");waitFor("Create Vehicle")
        setEditField(0,"Civic",2);setEditField(1,"80000",2);click("Create Vehicle")
        waitFor("TripRabbit");waitForContains("Civic");waitFor("80,000")
        click("Add Reading");setEditField(0,"80100",1);device.pressBack();click("Save Reading");waitFor("Reading added");waitFor("TripRabbit");waitFor("80,100")
        ...
        device.pressHome();val context=ApplicationProvider.getApplicationContext<Context>();context.startActivity(Intent(context,Class.forName("com.jacobgain.triprabbit.MainActivity")).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK));waitFor("TripRabbit");waitForContains("Golf");waitFor("120,400")

        click("Settings");waitFor("About");click("Privacy policy");waitFor("TripRabbit privacy policy");waitForContains("does not collect, transmit, sell, or share")
