...
class TripRabbitDatabaseTest {
    ...
    @Test fun vehicleCreationIncludesInitialReading()=runBlocking {
        val settings=object:SettingsRepository{override fun observeSettings():Flow<AppSettings> = flowOf(AppSettings());override suspend fun setSelectedVehicle(id:Long?){};override suspend fun setFirstLaunchComplete(complete:Boolean){};override suspend fun setThemeMode(value:com.jacobgain.triprabbit.core.model.ThemeMode){};override suspend fun setAccentTheme(value:com.jacobgain.triprabbit.core.model.AccentTheme){};override suspend fun setDynamicColor(value:Boolean){};override suspend fun setAmoledBlack(value:Boolean){};override suspend fun setDisplayDensity(value:com.jacobgain.triprabbit.core.model.DisplayDensity){};override suspend fun setConfirmReadingDeletion(value:Boolean){}}
