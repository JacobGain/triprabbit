package com.roadlog.core.repository
...
class DataRepositoryTest {
    ...
    private lateinit var db:RoadLogDatabase;private lateinit var repository:DataRepositoryImpl;private lateinit var directory:File
    @Before fun setup(){db=Room.inMemoryDatabaseBuilder(context,RoadLogDatabase::class.java).allowMainThreadQueries().build();repository=DataRepositoryImpl(context,db);directory=File(context.cacheDir,"backup-tests").apply{mkdirs()}}
